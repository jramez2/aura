...
- **Entry Point**: `api/index.php` (Front Controller)
...
Para inicializar las tablas maestras (Planes, Estados, Monedas, Categorías):
👉 `GET https://adminnube.com/aura/api/v1/setup/seed`
